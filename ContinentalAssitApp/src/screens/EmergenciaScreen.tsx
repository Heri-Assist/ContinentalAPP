...
import { ChatMotivo} from '../interfaces/motivoChatInterface';
...
export const EmergenciaScreen = ({ navigation }: Props) => {
  ...
  const { motivosChatData, motivosChat, entrarChat } =
            ...
            <View>
              <TouchableOpacity onPress={() => toggleExpansion(1)}>
                <View style={Style.listRow}>
                  ...
                  <View style={Style.textContainer}>
                    <Text style={Style.titleBoldList}>
                      {t('emergencia.chatEmergencia')}{' '}
                    </Text>
                  </View>
                  <View>
                    {isExpanded1 ? (
                ...
                {isExpanded1 && (
                  <View style={Style.infoContent}>
                    <TouchableOpacity style={Style.btnChat} onPress={showModal}>
              ...
              <TouchableOpacity onPress={() => toggleExpansion(2)}>
                <View style={Style.listRow}>
                  ...
                  <View style={Style.textContainer}>
                    <Text style={Style.titleBoldList}>
                      {t('emergencia.telefonoEmergencia')}
                    </Text>
                  </View>
                  <View>
                    {isExpanded2 ? (
                ...
                {isExpanded4 && (
                  <View style={Style.infoContent}>
                    {idioma == 'en' ? (
                      <TouchableOpacity
                        onPress={() =>
                          openEmailLink('emergency@continentalassist.com')
                        }>
                        <Text style={Style.text2}>
                          Email: emergency@continentalassist.com
                        </Text>
                      </TouchableOpacity>
                    ) : (
                      <TouchableOpacity
                        onPress={() =>
                          openEmailLink('emergencia@continentalassist.com')
                        }>
                        <Text style={Style.text2}>
                          Email: emergencia@continentalassist.com
                        </Text>
                      </TouchableOpacity>
                    )}
                  </View>
                  ...
                  <View style={Style.pickerContainer}>
                    {idioma == 'en' ? (
                      <RNPickerSelect
                        ...
                        items={
                          motivosChatData?.map((motivo: ChatMotivo) => ({
