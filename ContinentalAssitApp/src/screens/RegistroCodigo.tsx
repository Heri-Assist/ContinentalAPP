...
export const RegistroCodigo = ({ navigation }: PropsStack) => {
  const { errorMessage, removeError, formData } = useContext(AuthContext);
  ...
  const onValidarCodigo = async (data: UsuarioRegistro) => {
    ...
    try {
      ...
      if (enviarCodigo.data.error === false) {
        ...
        Alert.alert(
          'Codigo Incorrecto',
          enviarCodigo.data.resultado[0].mensaje_error,
        ...
        <View style={Style.formContainer}>
          <TouchableOpacity
            ...
            <Text style={Style.textButton}>
              {t('registroCodigo.validarCodigo')}
            </Text>
          </TouchableOpacity>
        </View>
        <View style={Style.formContainer}>
          <TouchableOpacity
            ...
            <Text style={Style.textButton}>
              {t('registroCodigo.volverAEnviar')}
            </Text>
          </TouchableOpacity>
        </View>
      </View>
