  ...
  return (
    <View style={Style.sliderContainer}>
      <View style={Style.sliderRow}>
        <Icon name="file" size={20} style={Style.icon2} />
      ...
      <View style={Style.sliderRow}>
        <Icon name="user" size={25} style={Style.icon2} />
        <View style={Style.textContainer}>
      ...
      <View style={Style.sliderRowAzul}>
        <Icon name="calendar" size={20} style={Style.icon3} />
        <View style={Style.textContainer}>
          <Text style={Style.textBold}>
            {t('miPlan.nacimientoBeneficiario')}
          </Text>
